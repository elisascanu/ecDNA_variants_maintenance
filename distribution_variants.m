...
yellowblockneu=yellowblock;
redblockneu=redblock;
mixblockneu=mixblock;
...
while length(Ryellow)<pop_size
    ...
    tauyes=random('Exponential',1/(2*yes));
...
yellowblocksel=yellowblock;
redblocksel=redblock;
mixblocksel=mixblock;
...
while length(Ryellow)<pop_size
    ...
    %%tauy=1/(2*yellow)*log(1/xi1);
    %%taur=1/(red)*log(1/xi1);
    tauy=random('Exponential',1/(2*yes));
...
yellowblockselnonid=yellowblock;
redblockselnonid=redblock;
mixblockselnonid=mixblock;
